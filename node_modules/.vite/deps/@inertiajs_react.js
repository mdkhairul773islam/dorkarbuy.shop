...
import { t as require_client } from "./client-DsanmFx0.js";
...
function isNamedLayouts(value, isComponent) {
	if (!isPlainObject(value) || isComponent(value) || "component" in value) return false;
	return Object.values(value).some((v) => isComponent(v) || Array.isArray(v) && isComponent(v[0]) || hasComponentKey(v) && isComponent(v.component));
}
